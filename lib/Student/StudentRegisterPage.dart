...
class StudentRegisterPage extends StatefulWidget {
  ...
  @override
  State<StudentRegisterPage> createState() => _TeacherRegister();
}

class _TeacherRegister extends State<StudentRegisterPage>{
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: (){
                  AuthFunctions().studentRegisterWithEmailAndPassword(_namecontroller.text,_emailcontroller.text, _passwordcontroller.text, _classgradecontroller.text);
